...
import me.hardcoded.smviewer.lwjgl.cache.WorldBlockCache;
import me.hardcoded.smviewer.lwjgl.shader.*;
...
import me.hardcoded.smviewer.lwjgl.WorldContentHandler;
...
//					bind(rend.textures);
		...
		//LOGGER.info("Total drawn triangles: %d", polys / 3);
	}
