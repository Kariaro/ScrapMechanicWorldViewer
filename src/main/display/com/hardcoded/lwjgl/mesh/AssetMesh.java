...
import com.hardcoded.world.types.Renderable.MeshMap;
...
public class AssetMesh {
	...
	public AssetMesh(Lod lod, AssetShader shader, SMAsset part) throws Exception {
